...
app.post("/familia/tarea/:id/borrar", async (c) => {
  await deleteChore(c.env, c.req.param("id"));
  return c.body(null, 204);
});
...
app.post("/familia/compra/:id/borrar", async (c) => {
  await deleteShoppingItem(c.env, c.req.param("id"));
  return c.body(null, 204);
});
